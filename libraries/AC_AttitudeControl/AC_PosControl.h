...
#define POSCONTROL_ACCEL_XY                     3500.0f  // default horizontal acceleration in cm/s/s.  This is overwritten by waypoint and loiter controllers
...
#define POSCONTROL_STOPPING_DIST_DOWN_MAX       0.0f  // max stopping distance (in cm) vertically while descending

#define POSCONTROL_SPEED                        3500.0f  // default horizontal speed in cm/s
#define POSCONTROL_SPEED_DOWN                  -3500.0f  // default descent rate in cm/s
